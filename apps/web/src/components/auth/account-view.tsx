  ...
  return (
    <div className="mt-6">
      <dl className="grid gap-4 rounded-xl border border-[#e3d8d4] bg-[#fdfaf9] p-4 text-sm">
        ...
        <div><dt className="font-bold text-[#3e3031]">Email status</dt><dd className="mt-1 text-[#665456]">{user.emailVerified ? "Verified" : "Pending verification (local development access)"}</dd></div>
      </dl>
